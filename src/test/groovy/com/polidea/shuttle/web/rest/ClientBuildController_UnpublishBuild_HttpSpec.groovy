...
class ClientBuildController_UnpublishBuild_HttpSpec extends HttpIntegrationSpecification {
    ...
    def "unpublish Build"() {
        ...
        when:
        def unpublishResponse = delete("/projects/${project.id}/apps/${platform}/${appId}/builds/${buildIdentifier}/publish", publisherToken)
    ...
    def "cannot unpublish Build if Project does not exist"() {
        ...
        when:
        def publishResponse = delete("/projects/${idOfNonExistentProject}/apps/${platform}/${appId}/builds/${buildIdentifier}/publish", publisherToken)
    ...
    def "cannot unpublish Build if App does not exist"() {
        ...
        when:
        def publishResponse = delete("/projects/${project.id}/apps/${platform}/${idOfNonExistentApp}/builds/${buildIdentifier}/publish", publisherToken)
    ...
    def "cannot unpublish Build if Build does not exist"() {
        ...
        when:
        def publishResponse = delete("/projects/${project.id}/apps/${platform}/${appId}/builds/${identifierOfNonExistentBuild}/publish", publisherToken)
    ...
    def "cannot unpublish Build if App exists but in another project"() {
        ...
        when:
        def publishResponse = delete("/projects/${anotherProject.id}/apps/${platform}/${appId}/builds/${buildIdentifier}/publish", publisherToken)
    ...
    def "User can unpublish Build if has Global Permission to do so"() {
        ...
        when:
        def publishResponse = delete("/projects/${project.id}/apps/${platform}/${appId}/builds/${buildIdentifier}/publish", publisherToken)
    ...
    def "User cannot unpublish Build if has no Global Permission to do so (globalPermission: #globalPermission)"(PermissionType globalPermission) {
        ...
        when:
        def publishResponse = delete("/projects/${project.id}/apps/${platform}/${appId}/builds/${buildIdentifier}/publish", nonPublisherToken)
